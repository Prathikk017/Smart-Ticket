...
const IndiviualTransAsset = () => {
    ...
    const getTransactionAssetData = async () => {
        const res = await axios.post(
          'https://amsweets.in/admin/readtransactionasset',
          {
            OperId,
          }
        );
      ...
      const handleClick = (totalAsset) =>{
        ...
        history(`/admin/transactionassetroute/${AstId}`);
      }
                      ...
                      return (
                        <React.Fragment key={i}>
                          <BoxWrapper >
                            ...
                            <div className='pl-4 cursor-pointer flex flex-col' onClick={()=> handleClick(data.totalAsset[i])}>
                              ...
                              <div className='flex items-center my-0 mb-1'>
                                <label className='text-sm text-gray-500 font-medium mr-2 text-center items-center justify-center'>Total Revenue:
                                </label>
...
export default IndiviualTransAsset;
