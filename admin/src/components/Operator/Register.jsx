...
const Register = () => {
  ...
  >
		<h2 className='text-4xl text-pink-500 text-center my-1'>
              Register
            </h2>
            ...
            <button
              type='submit'
              className='border w-full my-1 py-2 text-white bg-pink-500 rounded text-lg hover:bg-pink-400 duration-200'
              disabled={!verfied}
              onClick={handleSub}
            >
              Register
