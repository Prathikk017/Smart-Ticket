				...
				<div className='py-2 flex flex-col justify-center items-center'>
					<form className='max-w-[400px] w-full'>
						...
						<div className='flex flex-row py-2'>
							<label className='justify-center items-center mr-16 mt-1'>Route Name: </label>
							<input
								type='text'
								name='RouteName'
								value={RouteName}
						...
						<div className='flex flex-row py-2'>
							<label className='justify-center items-center mr-3 mt-1'>Route Effective date: </label>
							<input
								type='date'
								name='RouteEffDate'
								value={RouteEffDate}
						...
						<div className='flex flex-row py-2'>
							<label className='justify-center items-center mr-8 mt-1'>Route Start Stage: </label>
							<select
						...
						<div className='flex flex-row py-2'>
							<label className='justify-center items-center mr-10 mt-1'>Route End Stage: </label>
							<select
								className='border p-1 rounded w-[58%] hover:border-pink-500 duration-200'
								onChange={endStage}
								name='RouteEStage'
