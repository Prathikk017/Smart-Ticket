...
const addAuth = (AdminId) =>{
    var query = "INSERT INTO tblauth(AuthID, MobileNo, Email, Password, Flag) SELECT AdminId, Amobile, Aemail, Apassword, Flag FROM tbllpadm WHERE AdminId = ?"
...
const addAuth1 = (OperId)=>{
    var query = "INSERT INTO tblauth(AuthID, MobileNo, Email, Password, Flag) SELECT OperId, OperPhone, OperEmail, OperPassword, Flag FROM tbloperator WHERE OperId= ?"
